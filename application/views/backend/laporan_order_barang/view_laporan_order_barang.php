...
<html>
<head>
	<title>View Laporan Order Barang</title>
...
<body class="hold-transition skin-purple-light sidebar-mini">
	<div class="wrapper">
        ...
        <div class="col-sm-12"> 
             <div class="card">
                <div class="card-body">
                        <?=  form_open('laporan_order_barang/controller_laporan_order_barang/print_periode') ?>
                                <div class="row">
                                    <div class="col-md-3">
			        ...
			        <a href="<?php echo base_url(). "laporan_order_barang/controller_laporan_order_barang"; ?>"><button style="float: right;" class="btn btn-primary">Refresh</button></a>
                   </div>
                </div>
        </div>
    </div>
			         ...
			         if (tanya == true) return true;
			            ...
			            <div class="box-body">
			              <table id="tbl_produk" class="table table-bordered table-striped tbl_produk">
			              	<table id="tbl_order_barang" class="table table-bordered table-striped tbl_order_barang">
			                <thead>
			                <tr>
			                  <th>No</th>
			                  <th>Nomer Order</th>
			                ...
			                <tr>
			                  ...
			                  <a onclick="return konfirmasi()" href="<?php echo base_url(). "laporan_order_barang/controller_laporan_order_barang/do_delete/".$d->kode_barang; ?>"><button class="btn btn-danger btn-sm">DELETE</button></a> -->
			                  </td>
			                </tr>
			                <?php $i++; } ?>
			                </tbody>
			          ...
			          <script>
						function btnPrint(){
				        var divToPrint  = document.getElementById('tbl_order_barang');
				        ...
				        popupWin.document.write('<html>\n\
				                                    ...
				                                    <body onload="window.print()">\n\
				                                        <h2 align="center">Report order_barang</h2>\n\
