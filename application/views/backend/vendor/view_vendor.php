			...
			<div class="content-wrapper">
			    ...
			    <section class="content-header">
			      <h1>Data Vendor</h1>
			        ...
			        <p></p>
			       <div>
			        <a href="<?php echo base_url(). "vendor/controller_vendor/add_data"; ?>">
            		<button class="btn btn-primary fa fa-plus">Add Data</button>
          		    ...
          		    <a href="<?php echo base_url(). "vendor/controller_vendor/export_excel"; ?>">
            	    <button style="float: right;" class="btn btn-sm btn-success fa fa-file-excel-o" title="EXCEL"></button>
          		    ...
          		    <!-- Print Pdf -->
          		    <i style="float: right;">&nbsp;</i>
          		    <a href="<?php echo base_url(). "vendor/controller_vendor/export_pdf"; ?>" target ="_blank">
			         ...
			         if (tanya == true) return true;
			            ...
			            <div class="box-body">
			              <table id="tbl_produk" class="table table-bordered table-striped tbl_produk">
			                ...
			                <tbody>
			                <?php $i = 1; foreach ($vendor->result() as $d) { ?>
			                <tr>
			                  <td><?php echo $i; ?></td>
			                  <td><?php echo $d->kode_vendor; ?></td>
			                  ...
			                  <td align="center" class="no-print">
			                    <a href="<?php echo base_url(). "vendor/controller_vendor/edit_data/".$d->kode_vendor; ?>"><button class="fa fa-pencil btn btn-sm btn-info" title="Edit"></button></a>
			                    <a onclick="return konfirmasi()" href="<?php echo base_url(). "vendor/controller_vendor/do_delete/".$d->kode_vendor; ?>"><button class="fa fa-trash btn btn-sm btn-danger" title="Delete"></button></a>
			                  </td>
			                </tr>
			                <?php $i++; } ?>
			                </tbody>
