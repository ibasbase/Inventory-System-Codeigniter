			         ...
			         if (tanya == true) return true;
			            ...
			            <div class="box-body">
			              <table id="tbl_produk" class="table table-bordered table-striped tbl_produk">
			               <form method="POST" action="<?php echo base_url(). "vendor/controller_vendor/do_edit"; ?>"> 

							<tr>
								<td width="110">KODE VENDOR</td>
								<td>
								<input type="text" name="kode_vendor" size="30" value="<?php echo $kode_vendor; ?>" required/>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
								<input type="text" name="nama_vendor" size="30" value="<?php echo $nama_vendor; ?>" required/>
								</td>
							</tr>
