...
<html>
<head>
	<title>View Laporan Barang Keluar</title>
...
<body class="hold-transition skin-purple-light sidebar-mini">
	<div class="wrapper">
        ...
        <div class="col-sm-12"> 
             <div class="card">
                <div class="card-body">
                        <?=  form_open('laporan_barang_keluar/controller_laporan_barang_keluar/print_periode') ?>
                                <div class="row">
                                    <div class="col-md-3">
			        ...
			        <a href="<?php echo base_url(). "laporan_barang_keluar/controller_laporan_barang_keluar"; ?>"><button style="float: right;" class="btn btn-primary">Refresh</button></a>
                   </div>
                </div>
        </div>
    </div>
			         ...
			         if (tanya == true) return true;
			            ...
			            <div class="box-body">
			              <table id="tbl_produk" class="table table-bordered table-striped tbl_produk">
			              	<table id="tbl_barang_keluar" class="table table-bordered table-striped tbl_barang_keluar">
			                <thead>
			                <tr>
			                  <th>No</th>
			                  <th>Tanggal</th>
			                ...
			                <tr>
			                  ...
			                  <a onclick="return konfirmasi()" href="<?php echo base_url(). "laporan_barang_keluar/controller_laporan_barang_keluar/do_delete/".$d->kode_barang; ?>"><button class="btn btn-danger btn-sm">DELETE</button></a> -->
			                  </td>
			                </tr>
			                <?php $i++; } ?>
			                </tbody>
			          ...
			          <script>
				        ...
				        popupWin.document.write('<html>\n\
				                                    ...
				                                    <body onload="window.print()">\n\
				                                        <h2 align="center">Report barang_keluar</h2>\n\
