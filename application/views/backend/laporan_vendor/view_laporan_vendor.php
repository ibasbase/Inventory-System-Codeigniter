...
<html>
<head>
	<title>View Laporan Vendor</title>
			         ...
			         if (tanya == true) return true;
			            ...
			            <div class="box-body">
			              <table id="tbl_produk" class="table table-bordered table-striped tbl_produk">
			              	<table id="tbl_vendor" class="table table-bordered table-striped tbl_vendor">
			                <thead>
			                <tr>
			                  <th>No</th>
			                  <th>Kode Vendor</th>
			                ...
			                <tr>
			                  ...
			                  <a onclick="return konfirmasi()" href="<?php echo base_url(). "laporan_vendor/controller_laporan_vendor/do_delete/".$d->kode_barang; ?>"><button class="btn btn-danger btn-sm">DELETE</button></a> -->
			                  </td>
			                </tr>
			                <?php $i++; } ?>
			                </tbody>
			          ...
			          <script>
						function btnPrint(){
				        var divToPrint  = document.getElementById('tbl_vendor');
				        ...
				        popupWin.document.write('<html>\n\
				                                    ...
				                                    <body onload="window.print()">\n\
				                                        <h2 align="center">Report vendor</h2>\n\
