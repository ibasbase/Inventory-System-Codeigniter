			         ...
			         if (tanya == true) return true;
			            ...
			            <div class="box-body">
			              <table id="tbl_produk" class="table table-bordered table-striped tbl_produk">
			              	<table id="tbl_customer" class="table table-bordered table-striped tbl_customer">
			                <thead>
			                <tr>
			                  <th>No</th>
			                  <th>Kode Customer</th>
			                ...
			                <tr>
			                  ...
			                  <a onclick="return konfirmasi()" href="<?php echo base_url(). "laporan_customer/controller_laporan_customer/do_delete/".$d->kode_barang; ?>"><button class="btn btn-danger btn-sm">DELETE</button></a> -->
			                  </td>
			                </tr>
			                <?php $i++; } ?>
			                </tbody>
			          ...
			          <script>
						function btnPrint(){
				        var divToPrint  = document.getElementById('tbl_customer');
				        ...
				        popupWin.document.write('<html>\n\
				                                    ...
				                                    <body onload="window.print()">\n\
				                                        <h2 align="center">Report customer</h2>\n\
