			         ...
			         if (tanya == true) return true;
			            ...
			            <div class="box-body">
			              <table id="tbl_produk" class="table table-bordered table-striped tbl_produk">
			                <form method="POST" action="<?php echo base_url(). "customer/controller_customer/do_add"; ?>">

							<tr>
								<td width="110">KODE CUSTOMER</td>
								<td>
									<input type="text" name="kode_customer" size="30" placeholder="Kode customer" required/>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<input type="text" name="nama_customer" size="30" placeholder="Nama customer" required/>
								</td>
							</tr>
