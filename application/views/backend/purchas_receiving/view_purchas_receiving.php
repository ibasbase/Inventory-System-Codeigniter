...
<html>
<head>
	<title>View Purchas Receiving</title>
		...
		<!-- start CONTENT -->
			<div class="content-wrapper">
			    ...
			    <section class="content-header">
			     ...
			     <div>
			      <p></p>
			      <a href="<?php echo base_url(). "purchas_receiving/controller_purchas_receiving/add_data"; ?>">
          		  ...
          		  <a href="<?php echo base_url(). "purchas_receiving/controller_purchas_receiving/export_excel"; ?>" target = "_blank">
            	  <button style="float: right;" class="btn btn-sm btn-success fa fa-file-excel-o" title="EXCEL"></button>
          		  ...
          		  <!-- Print Pdf -->
          		  <i style="float: right;">&nbsp;</i>
		          <a href="<?php echo base_url(). "purchas_receiving/controller_purchas_receiving/export_pdf"; ?>" target = "_blank">
			              ...
			              <table id="tbl_produk" class="table table-bordered table-striped tbl_produk">
			                ...
			                <tr>
			                  ...
			                  <td align="center" class="no-print">
			                    <a href="<?php echo base_url(). "purchas_receiving/controller_purchas_receiving/edit_data/".$d->nomer_receiving; ?>"><button class="fa fa-pencil btn btn-sm btn-info" title="Edit"></button></a>
			                    <a onclick="return konfirmasi()" href="<?php echo base_url(). "purchas_receiving/controller_purchas_receiving/do_delete/".$d->nomer_receiving; ?>"><button class="fa fa-trash btn btn-sm btn-danger" title="Delete"></button></a>
			                  </td>
			                </tr>
			                <?php $i++; } ?>
			                </tbody>
