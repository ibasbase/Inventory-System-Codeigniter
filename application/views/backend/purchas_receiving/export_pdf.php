...
$title = <<<EOD
	<h1>Report Purchas Receiving</h1>
EOD;
...
$pdf->WriteHTMLCell(0, 0, '', '', $title, 0, 1, 0, true, 'C', true);
	...
	$table .= '<tr style="background-color:#ccc;">
					...
					<th style="border:1px solid #000;">NOMER RECEIVING</th>
	...
	$no = 1;
	foreach($purchas_receiving->result() as $row){
	$table .=	'<tr>
					<td style="border:1px solid #000;">'.$no++.'</td>
					<td style="border:1px solid #000;">'.$row->nomer_receiving.'</td>
...
ob_clean();
$pdf->Output('report_purchas_receiving.pdf', 'I');
