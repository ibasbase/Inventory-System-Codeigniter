			    ...
			    <section class="content-header">
			      <h1>Edit Barang Masuk</h1>
			        ...
			        <ol class="breadcrumb">
			        	...
			        	<li class="active">Edit Order Barang</li>
			        </ol>
			         ...
			         if (tanya == true) return true;
			            ...
			            <div class="box-body">
			              <table id="tbl_produk" class="table table-bordered table-striped tbl_produk">
			               <form method="POST" action="<?php echo base_url(). "order_barang/controller_order_barang/do_edit"; ?>"> 
