...
<html>
<head>
	<title>Tambah Order Barang</title>
			    ...
			    <section class="content-header">
			      <h1>Tambah Order Barang</h1>
			        ...
			        <ol class="breadcrumb">
			        	...
			        	<li class="active">Tambah Order Barang</li>
			        </ol>
			    ...
			    <section class="content">
			      <div class="box">
				      ...
				      if($this->uri->segment(3) == "edit"){
				        ...
				        $kode = generate_order_barang('nomer_order', 'order_barang', 'ORD');
				      }
				    ?>
			         ...
			         if (tanya == true) return true;
			            ...
			            <div class="box-body">
			              <table id="tbl_produk" class="table table-bordered table-striped tbl_produk">
			                <form method="POST" action="<?php echo base_url(). "order_barang/controller_order_barang/do_add"; ?>">

							<tr>
								<td width="130" hidden="hidden">NOMER ORDER</td>
								<td>
									<input type="hidden" value="<?php echo $kode; ?>" class="form-control" name="nomer_order" size="10">
								</td>
							</tr>
							...
							<tr>
								<td width="110">JUMLAH ORDER</td>
								<td>
									<input type="text" name="jumlah_order" size="30" placeholder="Jumlah Order" required/>
								</td>
							</tr>
