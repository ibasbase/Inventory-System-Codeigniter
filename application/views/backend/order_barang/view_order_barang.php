		...
		<!-- start CONTENT -->
			<div class="content-wrapper">
			    ...
			    <section class="content-header">
			     ...
			     <div>
			      <p></p>
			      <a href="<?php echo base_url(). "order_barang/controller_order_barang/add_data"; ?>">
          		  ...
          		  <a href="<?php echo base_url(). "order_barang/controller_order_barang/export_excel"; ?>" target = "_blank">
            	  <button style="float: right;" class="btn btn-sm btn-success fa fa-file-excel-o" title="EXCEL"></button>
          		  ...
          		  <!-- Print Pdf -->
          		  <i style="float: right;">&nbsp;</i>
		          <a href="<?php echo base_url(). "order_barang/controller_order_barang/export_pdf"; ?>" target = "_blank">
			              ...
			              <table id="tbl_produk" class="table table-bordered table-striped tbl_produk">
			                ...
			                <tr>
			                  ...
			                  <td align="center" class="no-print">
			                    <a href="<?php echo base_url(). "order_barang/controller_order_barang/edit_data/".$d->nomer_order; ?>"><button class="fa fa-pencil btn btn-sm btn-info" title="Edit"></button></a>
			                    <a onclick="return konfirmasi()" href="<?php echo base_url(). "order_barang/controller_order_barang/do_delete/".$d->nomer_order; ?>"><button class="fa fa-trash btn btn-sm btn-danger" title="Delete"></button></a>
			                  </td>
			                </tr>
			                <?php $i++; } ?>
			                </tbody>
