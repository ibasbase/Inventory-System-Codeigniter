...
<html>
<head>
	<title>View Laporan Purchas Reture</title>
...
<body class="hold-transition skin-purple-light sidebar-mini">
	<div class="wrapper">
        ...
        <div class="col-sm-12"> 
             <div class="card">
                <div class="card-body">
                        <?=  form_open('laporan_purchas_reture/controller_laporan_purchas_reture/print_periode') ?>
                                <div class="row">
                                    <div class="col-md-3">
			        ...
			        <a href="<?php echo base_url(). "laporan_purchas_reture/controller_laporan_purchas_reture"; ?>"><button style="float: right;" class="btn btn-primary">Refresh</button></a>
                   </div>
                </div>
        </div>
    </div>
			         ...
			         if (tanya == true) return true;
			            ...
			            <div class="box-body">
			              <table id="tbl_produk" class="table table-bordered table-striped tbl_produk">
			              	<table id="tbl_purchas_reture" class="table table-bordered table-striped tbl_purchas_reture">
			                <thead>
			                <tr>
			                  <th>No</th>
			                  <th>Nomer Reture</th>
			                ...
			                <tbody>
			                <?php $i = 1; foreach ($purchas_reture->result() as $d) { ?>
			                <tr>
			                  <td><?php echo $i; ?></td>
			                  ...
			                  <a onclick="return konfirmasi()" href="<?php echo base_url(). "laporan_purchas_order/controller_laporan_purchas_order/do_delete/".$d->kode_barang; ?>"><button class="btn btn-danger btn-sm">DELETE</button></a> -->
			                  </td>
			                </tr>
			                <?php $i++; } ?>
			                </tbody>
			          ...
			          <script>
						function btnPrint(){
				        var divToPrint  = document.getElementById('tbl_purchas_reture');
				        ...
				        popupWin.document.write('<html>\n\
				                                    ...
				                                    <body onload="window.print()">\n\
				                                        <h2 align="center">Report purchas_reture</h2>\n\
