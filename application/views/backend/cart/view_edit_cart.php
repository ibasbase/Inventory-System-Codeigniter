			    ...
			    <section class="content">
			      <div class="box">
			            <div class="box-header">
			              <h3 class="box-title">Data Table With Full Edit</h3>
			            </div>
			            <!-- Validasi Edit Data -->
			         ...
			         if (tanya == true) return true;
			            ...
			            <div class="box-body">
			              <table id="tbl_produk" class="table table-bordered table-striped tbl_produk">
			               <form method="POST" action="<?php echo base_url(). "barang_keluar/controller_barang_keluar/do_add"; ?>">

							<tr>
								<td width="110">NOMER TRANSAKSI</td>
								<td>
								<input type="text" name="nomer_transaksi" size="30" readonly="readonly" value="<?php echo $nomer_transaksi; ?>">
								</td>
							</tr>
							...
							<tr>
								...
								<td>
								<input type="date" name="tanggal" size="30" readonly="readonly" value="<?php echo $tanggal; ?>" required/>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
								<input type="text" name="kode_barang" size="30" readonly="readonly" value="<?php echo $kode_barang; ?>" required/>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
								<input type="text" name="jumlah_barang" size="30" readonly="readonly" value="<?php echo $jumlah_barang; ?>" required/>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
								<input type="text" name="satuan" size="30" readonly="readonly" value="<?php echo $satuan; ?>" required/>
								</td>
							</tr>
