			    ...
			    <section class="content-header">
			      <h1>Edit Barang Masuk</h1>
			        ...
			        <ol class="breadcrumb">
			        	...
			        	<li class="active">Edit Purchas Order</li>
			        </ol>
			         ...
			         if (tanya == true) return true;
			            ...
			            <div class="box-body">
			              <table id="tbl_produk" class="table table-bordered table-striped tbl_produk">
			               <form method="POST" action="<?php echo base_url(). "purchas_order/controller_purchas_order/do_edit"; ?>"> 

							<tr>
								<td width="110" hidden="hidden">NOMER ORDER</td>
								<td>
								<input type="text" name="nomer_order" size="30" hidden="hidden" value="<?php echo $nomer_order; ?>">
								</td>
							</tr>
							...
							<tr>
								...
								<td>
								<input type="text" name="jumlah_order" size="30" value="<?php echo $jumlah_order; ?>" required/>
								</td>
							</tr>
