...
$pdf->WriteHTMLCell(0, 0, '', '', $title, 0, 1, 0, true, 'C', true);
	...
	$table .=	'<tr>
					...
					<td style="border:1px solid #000;">'.$row->jumlah_reture.'</td>
...
ob_clean();
$pdf->Output('report_reture_barang.pdf', 'I');
