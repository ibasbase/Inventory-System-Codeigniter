...
<head>
	...
	<title>Dashboard Warehuse</title>
	<?php $this->load->view('backend/template_warehouse/link.php'); ?>
</head>
...
<body class="hold-transition skin-green-light sidebar-mini">
	<div class="wrapper">
		<!-- start HEADER -->
		<div>
			<?php $this->load->view('backend/template_warehouse/header.php'); ?>
		</div>
		<!-- end HEADER -->

		<!-- start SIDEBAR -->
		<div>
			<?php $this->load->view('backend/template_warehouse/sidebar.php'); ?>
		</div>
		<!-- end SIDEBAR -->
		...
		<!-- start FOOTER -->
		<div>
			<?php $this->load->view('backend/template_warehouse/footer.php'); ?>
		</div>
		<!-- end FOOTER -->
	</div>
</body>
