...
<html>
<head>
	<title>View Laporan Purchas Receiving Reture</title>
...
<body class="hold-transition skin-purple-light sidebar-mini">
	<div class="wrapper">
		...
		<!-- start CONTENT -->
			<div class="content-wrapper">
			    ...
			    <section class="content-header">
			      <h1>Laporan Purchas Receiving Reture</h1>
        ...
        <div class="col-sm-12"> 
             <div class="card">
                <div class="card-body">
                        <?=  form_open('laporan_purchas_receivingrtr/controller_laporan_purchas_receivingrtr/print_periode') ?>
                                <div class="row">
                                    <div class="col-md-3">
			        ...
			        <a href="<?php echo base_url(). "laporan_purchas_receivingrtr/controller_laporan_purchas_receivingrtr"; ?>"><button style="float: right;" class="btn btn-primary">Refresh</button></a>
                   </div>
                </div>
        </div>
    </div>
			         ...
			         if (tanya == true) return true;
			            ...
			            <div class="box-body">
			              <table id="tbl_produk" class="table table-bordered table-striped tbl_produk">
			              	<table id="tbl_purchas_receivingrtr" class="table table-bordered table-striped tbl_purchas_receivingrtr">
			                <thead>
			                <tr>
			                  <th>No</th>
			                  <th>Nomer Receiving Reture</th>
			                  <th>Tanggal</th>
			                  <th>Nomer Reture</th>
			                  <th>Kode Barang</th>
			                  <th>Jumlah Barang</th>
			          ...
			          <script>
						function btnPrint(){
				        var divToPrint  = document.getElementById('tbl_purchas_receivingrtr');
				        ...
				        popupWin.document.write('<html>\n\
				                                    ...
				                                    <body onload="window.print()">\n\
				                                        <h2 align="center">Report Purchas Receiving Reture</h2>\n\
