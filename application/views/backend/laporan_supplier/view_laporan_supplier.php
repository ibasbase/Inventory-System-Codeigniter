...
<html>
<head>
	<title>View Laporan Supplier</title>
			         ...
			         if (tanya == true) return true;
			            ...
			            <div class="box-body">
			              <table id="tbl_produk" class="table table-bordered table-striped tbl_produk">
			              	<table id="tbl_supplier" class="table table-bordered table-striped tbl_supplier">
			                <thead>
			                <tr>
			                  <th>No</th>
			                  <th>Kode Supplier</th>
			                ...
			                <tr>
			                  ...
			                  <a onclick="return konfirmasi()" href="<?php echo base_url(). "laporan_supplier/controller_laporan_supplier/do_delete/".$d->kode_barang; ?>"><button class="btn btn-danger btn-sm">DELETE</button></a> -->
			                  </td>
			                </tr>
			                <?php $i++; } ?>
			                </tbody>
			          ...
			          <script>
						function btnPrint(){
				        var divToPrint  = document.getElementById('tbl_supplier');
				        ...
				        popupWin.document.write('<html>\n\
				                                    ...
				                                    <body onload="window.print()">\n\
				                                        <h2 align="center">Report supplier</h2>\n\
